...
double launchHumanCannonball (double initialVelocity, double launchAngle)
{
	...
	double xVelocity = initialVelocity * cos(radangle);
	double yVelocity = initialVelocity * sin(radangle) * -1;
	double flightTime = (yVelocity) * 2/-9.8;
	double xDistance = xVelocity * flightTime;
